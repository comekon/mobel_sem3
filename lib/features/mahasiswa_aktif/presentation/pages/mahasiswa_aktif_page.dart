...
import 'package:mobel1/features/mahasiswa_aktif/presentation/providers/mahasiswa_aktif_provider.dart';
import 'package:mobel1/features/mahasiswa_aktif/presentation/widgets/mahasiswa_aktif_widget.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: mahasiswaAktifState.when(
        ...
        data: (mahasiswaList) => MahasiswaAktifListView(
